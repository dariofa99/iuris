export class UserService {
  ...
  async findUserWithFilter(request) {
  ...
  async getUsersByIdnumber(request) {
    const response = await fetch(BASE_URL + 'usuarios/get/by/idnumber?' + new URLSearchParams(request), {
      method: 'GET',
      headers: {
        "Content-Type": "application/json",
        "Accept": "application/json",
  ...
  async findUserWithFilterByNameOrLastNameAndRole(request) {
