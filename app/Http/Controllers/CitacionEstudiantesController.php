...
class CitacionEstudiantesController extends Controller
{
  ...
  //      return response()->json($expediente);
        ...
        $citacion->fecha = getSmallDate($request->fecha);
        $citacion->fecha_corta = $request->fecha;
    ...
    public function listCorreoCitasGen()
    {
        ...
        $fechasem = [
            0 => ['Lunes' => '2020-05-04', 'Martes' => '2020-05-05', 'Miercoles' => '2020-05-06', 'Jueves' => '2020-05-07', 'Viernes' => '2020-05-08'],
