    ...
    <input {{isset($disabled) ? $disabled : ''}} id='id' value="{{(isset($user)) ? $user->id:"" }}" name='id' type="hidden" maxlength="12" >
           
          
        <div class="col-md-{{isset($col)?$col:'6'}}">
            <div class="form-group has-feedback"><label for="idnumber">Tipo de Persona<span class="ast_required">*</span></label>
              <select {{isset($disabled) ? $disabled : ''}} required name="tipopers_id" id="tipopers_id" class="form-control form-control-sm required">
        ...
        <div class="col-md-{{isset($col)?$col:'6'}}">
         ...
         <div class="col-md-{{isset($col)?$col:'6'}}">
            <div class="form-group has-feedback"><label for="idnumber">Número de documento<span class="ast_required">*</span></label>
            <input {{isset($disabled) ? $disabled : ''}} id='idnumber' value="{{(isset($user)) ? $user->idnumber:"" }}" name='idnumber' required type="text" class="form-control form-control-sm onlynumber required"  data-toggle="tooltip" title="Solo números"  placeholder="Número de documento" maxlength="12" >
        ...
        <div class="col-md-{{isset($col)?$col:'6'}}">
            <div class="form-group has-feedback"><label for="name">Apellidos<span class="ast_required">*</span></label>
                <input {{isset($disabled) ? $disabled : ''}} id='lastname' value="{{(isset($user)) ? $user->lastname:"" }}" name='lastname' required type="text" class="form-control form-control-sm required"  data-toggle="tooltip" title="Apellidos"  placeholder="Apellidos" maxlength="20" >
                
            </div>  
        </div>
       <div class="col-md-{{isset($col)?$col:'6'}}">
            <div class="form-group has-feedback"><label for="name">Dirección para notificaciones<span class="ast_required">*</span></label>
        ...
        <div class="col-md-{{isset($col)?$col:'6'}}">
            <div class="form-group has-feedback"><label for="name">Correo electrónico<span class="ast_required">*</span></label>
        ...
        <div class="col-md-{{isset($col)?$col:'6'}}">
            <div class="form-group has-feedback"><label for="name">Telefóno celular<span class="ast_required">*</span></label>
                <input {{isset($disabled) ? $disabled : ''}} id='tel1' value="{{(isset($user)) ? $user->tel1:"" }}" name='tel1' required type="text" class="form-control form-control-sm onlynumber required"  data-toggle="tooltip" title="Número de contacto"  placeholder="Número de contacto" maxlength="10" >
