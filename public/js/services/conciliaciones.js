export class ConciliacionService {
    ...
    async getActasCreadas(request) {
        const response = await fetch(BASE_URL + "conciliacion/get/actas/creadas?" + new URLSearchParams(request), {
            method: 'GET',
            headers: {
                "Content-Type": "application/json",
                "Accept": "application/json",
    ...
    async crearActa(request) {
        const response = await fetch(BASE_URL + "crear/actas/by/status", {
            method: 'POST',
            headers: {
                "Content-Type": "application/json",
                "Accept": "application/json",
    ...
    async getFirmantes(request) {
        const response = await fetch(BASE_URL + 'conciliacion/reporte/firmantes?' +
    ...
    async reenviarMails(request) {
        const response = await fetch(BASE_URL + "conciliacion/reporte/firmantes/reenviar/mails", {
            method: 'POST',
            headers: {
                "Content-Type": "application/json",
                "Accept": "application/json",
    ...
    async revocarFirmas(request) {
        const response = await fetch(BASE_URL + "conciliacion/reporte/revocar/firmas", {
            method: 'POST',
            headers: {
                "Content-Type": "application/json",
                "Accept": "application/json",
    ...
    async generarPdfs(request) {
        const response = await fetch(BASE_URL + "conciliaciones/generate/documents", {
            method: 'POST',
            headers: {
                "Content-Type": "application/json",
                "Accept": "application/json",
    ...
    async getStatusFiles(request) {
        const response = await fetch(BASE_URL + 'conciliaciones/get/status/files?' +
            new URLSearchParams(request), {
            method: 'GET',
            headers: {
                "Content-Type": "application/json",
        ...
        $("#" + form + " .input_user_ad").each((index, obj) => {
            ...
            || $(obj).attr("data-type") == 170) && $(obj).is(":checked"))
                || (($(obj).attr("data-type") != 170 && $(obj).attr("data-type") != 169 ) && $(obj).val() != '')) {
                   console.log($(obj).attr("data-type"));
                    data.push({
