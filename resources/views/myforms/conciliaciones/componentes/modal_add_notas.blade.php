        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    {!! Form::text('ntamanaudiencia', null, [
                        'class' => 'form-control required val_nota',
                        'id' => 'ntamanaudiencia',
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    {!! Form::text('ntaanalisisformulas', null, [
                        'class' => 'form-control required val_nota',
                        'id' => 'ntaanalisisformulas',
                        'data-inputmask' => "'mask': ['9.9']",
                        'data-mask' => '',
                    ]) !!}
                </div>
            ...
            <div class="row" id="content_nota_auxiliar">
                <div class="col-md-6">
                    <div class="form-group">
                        {!! Form::label('Nota: Plantillas de conciliación') !!}
                        {!! Form::text('ntaplanconciliacion', null, [
                            'class' => 'form-control required val_nota',
                            'id' => 'ntaplanconciliacion',
                            'data-inputmask' => "'mask': ['9.9']",
                            'data-mask' => '',
                        ]) !!}
                    </div>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    {!! Form::text('ntaprespersonal', null, [
                        'class' => 'form-control required val_nota',
                        'id' => 'ntaprespersonal',
                        'data-inputmask' => "'mask': ['9.9']",
                        'data-mask' => '',
