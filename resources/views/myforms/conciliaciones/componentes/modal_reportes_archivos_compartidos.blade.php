        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" id="info-tab" data-toggle="tab" href="#compartir" role="tab"
                    ...
                    <li class="nav-item">
                        <a class="nav-link " id="compartidos-tab" data-toggle="tab" href="#compartidos" role="tab"
                            aria-controls="estado" aria-selected="true">
                            Compartidos
                        </a>
                    </li>
                </ul>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9" id="content_shmail" style="display: none">
                                    ...
                                    <div class="input-group">
                                        <input type="email" disabled id="input_email" class="shared_mail form-control"
                                            placeholder="Ingrese un correo electrónico" aria-describedby="basic-addon2">
                                        <span class="btn btn-success input-group-addon" id="btn_addmail"><i
