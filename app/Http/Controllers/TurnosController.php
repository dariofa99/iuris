    ...
    public function index(Request $request)
    {
        ...
        $turnos = Turno::join('users', 'users.idnumber', '=', 'turnos.trnid_estudent')
            ...
            ->select(
                ...
                'users.lastname',
                'trnid_color',
                'rc.ref_value as color_ref_value',
                'rc.ref_nombre as color_nombre',
                'cursos.id as curso_id',
                'cursos.ref_nombre as curso_nombre',
                'rh.ref_nombre as horario_nombre',
                'trnid_horario',
                'trnid_oficina',
                'oficinas.nombre as oficina_nombre',
                'rd.ref_nombre as dia_nombre',
                'trnid_dia'
            )
