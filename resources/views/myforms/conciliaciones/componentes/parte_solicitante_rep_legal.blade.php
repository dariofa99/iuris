        ...
        <h4 >
           ...
           @if( ((currentUser()->hasRole('diradmin') || currentUser()->hasRole('coord_centro_conciliacion') || currentUser()->hasRole('amatai')))
            || ((currentUserInConciliacion($conciliacion->id,['autor','auxiliar','conciliador']))))
             ...
             @if(!Request::has('id'))
             <button type="button" @if($user->idnumber!=null) data-user="{{$user->idnumber}}" @endif data-section="rep_legal_solicitante" data-type="{{$tipo_usuario_id}}" class="btn btn-primary btn-sm btn_asinar_usuario_conciliacion pull-right">  
...
<div class="row">
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            @if(($conciliacion->estado_id!=177 and $conciliacion->estado_id!=179)  and !auth()->user()->can('act_conciliacion'))
                ...
                @else 
                class="form-control form-control-sm insert_adv required"
                @endif>
    ...
    <div class="col-md-3">
        <div class="form-group">
			<label >  
                Nombres *</label>
            <input @if(!Request::has('id') || $user->idnumber!=null) disabled @endif data-name="nombre"  data-section="{{$section}}" required  type="text"
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input @if(!Request::has('id') || $user->idnumber!=null) disabled @endif data-name="addreess"  data-section="{{$section}}" required  type="text"
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input @if(!Request::has('id') || $user->idnumber!=null) disabled @endif
             data-name="{{$question->short_name}}"  data-section="{{$question->section}}" required  type="text"
