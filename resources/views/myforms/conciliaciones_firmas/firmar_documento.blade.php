            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                                    ...
                                    <table class="table" id="myReportPdfList">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-warning btn-sm pull-right" target="_blank"
                                                        href="/pdf/reportes/generate/{{ $user->conciliacion_id }}/{{ $pdf_report->reporte_id }}/{{ $pdf_report->status_id }}">
                                                        Vista previa </a>
                                                </td>
                        ...
                        <hr>
                        <div id="respu_firma" style="display: none" class="alert alert-success alert-dismissible"
                            role="alert">
