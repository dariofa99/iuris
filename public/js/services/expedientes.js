export class ExpedientesService {
    ...
    async cambiarFechaEvaluacion(request) {
        const response = await fetch(BASE_URL + 'expedientes/cambiar/fecha/evaluacion', {
            method: 'POST',
            headers: {
                "Content-Type": "application/json",
                "Accept": "application/json",
    ...
    async cerrarCasoNotaMinima(request) {
        const response = await fetch(BASE_URL + 'estado/caso/cerrar/minima', {
            method: 'POST',
            headers: {
                "Content-Type": "application/json",
                "Accept": "application/json",
    ...
    async addUser(request) {
        const response = await fetch(BASE_URL + 'expediente/add/user', {
            method: 'POST',
            headers: {
                "Content-Type": "application/json",
                "Accept": "application/json",
