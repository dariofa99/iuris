...
class User extends Authenticatable
{
    ...
    {
        return $this->belongsTo(TablaReferencia::class, 'tipodoc_id');
    }
    public function genero()
    {
        return $this->belongsTo(TablaReferencia::class, 'genero_id');
    }
    public function tipo_persona()
    {
        return $this->belongsTo(TablaReferencia::class, 'tipopers_id');
    }
        ...
        if (count($notas) > 0) {
            ...
            foreach ($notas as $key => $nota) {
                ...
                $data = [
                    ...
                    'proceso' => $nota->expediente->exptipoproce_id  != 3 ? 'Defensa' : 'Expediente',
                ...
                ($origen[$nota->expidnumber][] = [
                    ...
                    'proceso' => $nota->expediente->exptipoproce_id  == 3 ? 'Defensa de oficio' : 'Expediente',
