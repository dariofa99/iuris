    ...
    <script>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              <label>Anotación:</label>
                <textarea class="form-control" name="descripregisdocasis" id="descripregisdocasis" rows="3" placeholder="" style="margin: 0px 56.6px 0px 0px; max-width: 100%; width: 538px; height: 117px;">` +
                                    textareaasis + `</textarea>
            </div>
          </div>
        </div>
        <div class="modal-footer" id="fotermodaldoc">
