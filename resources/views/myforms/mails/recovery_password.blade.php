                ...
                <td style="overflow-wrap:break-word;word-break:break-word;padding:40px 40px 30px;font-family:'Lato',sans-serif;"
                    ...
                    <div style="font-size: 14px; line-height: 140%; text-align: left; word-wrap: break-word;">
                        ...
                        <p style="font-size: 14px; line-height: 140%;"><span
                                ...
                                Estas recibiendo este correo electrónico porque
                        ...
                        <p style="font-size: 14px; line-height: 140%;"><span
                                ...
                                Para restablecer la contraseña, por favor de clic en
                                el siguiente botón: </span></p>
                    </div>
            ...
            <tr>
                <td style="overflow-wrap:break-word;word-break:break-word;padding:0px 40px;font-family:'Lato',sans-serif;"
                    ...
                    <div align="left">
                        ...
                        <a href="{{ url('/password/reset/' . $token) }}" target="_blank" class="v-button"
                        ...
                        <p style="font-size: 14px; line-height: 140%;">
                            <span style="color: #888888; font-size: 10px; line-height: 19.6px;"><em>
                                    <span style="font-size: 14px; line-height: 22.4px;">
                                        <small>Ignore este correo electrónico si
                                            no solicitó un cambio de
                                            contraseña.</small>
                                    </span></em></span><br /><span
