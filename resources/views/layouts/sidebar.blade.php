  ...
  <aside class="main-sidebar sidebar-{{ $sidebar_modo }}-primary elevation-4" style="background-color:#222d32">
    <!-- Brand Logo -->
      ...
      <a href="/home" class="brand-link" style="background-color: #374850 !important; padding: .4125rem .5rem;text-align: center;" >    
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <a href="/admin/users/{{auth()->user()->id}}/edit" title="Ingresar a perfil">
          <img src="{{ is_file(public_path('thumbnails/'.currentUser()->image)) ? asset('thumbnails/'.currentUser()->image ) : asset('thumbnails/default.jpg' )}}" id="image_profile_user_sidebar" class="img-circle elevation-2 image_profile" alt="User Image">
        ...
        <div class="info">
          ...
          <span title="Color del turno"  class="badge {{ (currentUser()->getColorTurno(currentUser()->turno->color->ref_value)) }}">.</span>
         @else
...
<a  href="{{ route('logout.index') }}"
      ...
      {{--     <li class="nav-item has-treeview menu-open">
           ...
           <li class="nav-item has-treeview {{(!Route::is('expedientes.index') and !Route::is('expedientes.edit')) ?: 'menu-open'}}">
