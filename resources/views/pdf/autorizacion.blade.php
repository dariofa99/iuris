<table style="font-family:arial;font-size:13.333px;width:100%">
    <tr>
        ...
        <td style="border:1px solid black">
            ...
            <span style="padding:2px;display:block;text-align:left;border-bottom:1px solid black">Versión: 3</span>
        ...
        <tr>
            <td align="justify" style="font-family:arial;font-size:16px">
                ...
                <p>
                    ...
                    {{ parseLongDate($autorizacion->fecha_autorizado) }} para efectos de que trata el inciso 2º del
                    Artículo 1º de la Ley 583 de 2000.
                </p>
                <p>
                    <b>Nota: </b>Favor presentar copia del Acta de Posesión ante el Asistente Administrativo, en caso de
                    procesos penales ante los juzgados y fiscalías. Presentar copia de esta autorizacion con el sello de
                    recibido de la entidad correspondiente.
                </p>
            </td>
        </tr>
