...
<div class="card card-outline card-info" id="anexos_conciliacion">
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-12">
                <table class="table">
                    <tr class="border-left-4 border-left-info" id="row_doc_identidad">
                    ...
                    @if ($representantes_legales->count() > 0)
                        <tr class="border-left-4 border-left-warning" id="row_certificado_existencia">
                            <td class="align-middle">
                                <div class="d-flex align-items-center">
                    ...
                    @endif
                    <tr class="border-left-4 border-left-success" id="row_eva_socioeconomica">
                        <td class="align-middle">
                            <div class="d-flex align-items-center">
                    ...
                    <tr class="border-left-4 border-left-secondary" id="row_otros_documentos">
                        <td class="align-middle">
                            <div class="d-flex align-items-center">
