        ...
        <div id="cont_adm_docs">
            ...
            <ul class="nav nav-tabs">
                @if (currentUser()->can('crear_notif_oficina_virtual'))
                    <li class="active"><a id="a_tab_notificacion_create" href="#tab_notificacion_create" data-toggle="tab">Nueva</a>
                    </li>
                @endif
            ...
            <div class="tab-content">
                <!--Tab pane tab_3-->
                <div @if (currentUser()->can('crear_notif_oficina_virtual')) class="tab-pane active" @else class="tab-pane" @endif
                    id="tab_notificacion_create">
                    <div class="row">
                        <div class="col-md-12" id="content_create_notificacion">
                            <form method="POST" class="form_store" accept-charset="UTF-8" id="myformCreateNotificacion"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <button type="button" style="display:none" id="btn_cancel_upddoc"
