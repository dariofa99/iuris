                 ...
                 <table class="table">
                     ...
                     <tbody>
                         <tr>
                             ...
                             <td>
                                 <select data-live-search="true" name="numberest_id" disabled required id="numberest_id"
                                     class="required form-control disabled-fun4 selectpicker">
                                 ...
                                 {{-- {!!Form::select('numberest_id',$estudiantes, null,  ['class' => 'form-control selectpicker disabled-fun4', 'data-live-search'=>'true','required' => 'required','disabled','id'=>'numberest_id' ])!!}
 --}}
                             </td>
                             <td>
                                 <div>
                         ...
                         <tr>
                             ...
                             <td>
                                 <div style="display: none;" id="cont_anotacion">
                                     ...
                                     {!! Form::select('motivo_asig_id', $motivo_asig, null, [
                                     ...
                                     <textarea required class="form-control required" name="anotacion" id="anotacion" style="width: 100%" rows="4"></textarea>
                                 </div>
                             </td>
                         </tr>
                     </tbody>
