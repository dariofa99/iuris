                ...
                <div class="card-body">
                    <form id="myFormAgendarTurnoDocente">
                        ...
                        <label>Motivo</label>
                            ...
                            <textarea class="form-control form-control-sm required" name="motivo" id="motivo" cols="3" rows="5" placeholder="Ejemplo: Solicitar cierre de caso 2023A-2541 y revisión de derecho de petición de expediente 2025A-302, 2025A-303"></textarea>
