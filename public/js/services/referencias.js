class ReferenciasService {
    async referenceEdit(id) {
        const response = await fetch(BASE_URL + "categorias/" + id + "/edit", {
            method: 'GET',
            headers: {
    ...
    async referenceUpdate(request,id) {
    ...
    async getByRefDataFilter(request) {
        const response = await fetch(BASE_URL + "categorias/get/by/filter/?" + new URLSearchParams(request), {
            method: 'GET',
            headers: {
                "Content-Type": "application/json",
                "Accept": "application/json",
