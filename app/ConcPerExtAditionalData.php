...
class ConcPerExtAditionalData extends Model
{
    protected $table = 'concpersext_aditional_data';
    protected $fillable = [
    'value',
    'value_is_other',
    'reference_data_id',
    ...
    {
       return $this->belongsTo(ReferenceDataOptions::class,'reference_data_option_id','id');
    } 
