            ...
            @if ($expediente->expestado_id != '2' and $expediente->expestado_id != '4')
                ...
                @if ($expediente->exptipoproce_id != '1')
                    <button type="button"
                        ...
                        class="btn btn-primary btn-sm btn_new_act" data-toggle="modal" data-titulo_modal="Nueva actuación"
                        data-target="#myModal_act_create">Nueva Actuación</button>
                @endif
                ...
                <button type="button" class="btn btn-default btn-sm btn_new_act" data-toggle="modal"
                    data-target="#myModal_act_create" data-titulo_modal="Nuevo anexo" id="btn_new_anex">Agregar Anexo
                    General</button>
