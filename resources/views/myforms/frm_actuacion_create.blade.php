...
<div class="row">
	...
	@if($expediente->expestado_id <>'2' AND  $expediente->expestado_id <>'4' )
			...
			<button type="button" class="btn btn-default btn-sm btn_new_act" data-toggle="modal" data-target="#myModal_act_create" data-titulo_modal="Nuevo anexo" id="btn_new_anex">Agregar Anexo General</button>
