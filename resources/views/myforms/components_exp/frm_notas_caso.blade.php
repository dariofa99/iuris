                ...
                <div class="col-md-3 col-md-offset-9">
                    ...
                    @if ($segmento->fecha_fin >= date('Y-m-d'))
                        ...
                        || $expediente->expestado_id == 2)
                            ...
                            <input type="button" class="btn btn-primary pull-right add_nota_expedientes"
                                value="Asignar Notas Finales" data-toggle="modal"
                       ...
                       @elseif(
                            ...
                            <a class="btn btn-warning pull-right add_nota_expedientes" id="2" data-toggle="modal"
                                data-target="#myModal_add_nota_final_expedientes" data-placement="top"
                                data-original-title="Agregar Nota"><i class="fa  fa-calculator">
